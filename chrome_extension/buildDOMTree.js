...
// (function() { // REMOVED
    ...
    window.domTreeResult = (
            ...
            try {
                ...
                for (const { element, rect } of candidateElements) {
                    ...
                    if (iframeElement) {
                        ...
                        elementData.iframeElementPath = getElementPath(iframeElement, true);
                    }
                    ...
                    if (host.shadowRoot) {
                        ...
                        for (const { element, rect } of shadowCandidates) {
                            ...
                            elementData.shadowHost = {
                                ...
                                id: host.id || null,
                                elementPath: getElementPath(host, true)
                            };
        ...
        /**
         * Returns an element path string for an element.
         * This generates an XPath-like reference to locate the element.
         */
        function getElementPath(element, stopAtBoundary = true) {
            const segments = [];
            ...
            while (currentElement && currentElement.nodeType === Node.ELEMENT_NODE) {
                ...
                const pathIndex = position > 0 ? `[${position}]` : "";
        ...
        /**
         * Helper function to get element position relative to siblings of same type
         */
        ...
        function createElementData(element, index) {
            ...
            const elementData = {
                ...
                elementPath: getElementPath(element, true),
                ...
                if (element.id) {
                    ...
                    if (explicitLabel) {
                        ...
                        elementData.labelElement = {
                            ...
                            elementPath: getElementPath(explicitLabel, true)
                        };
                    }
                }
                    ...
                    while (parent && parent !== document.body) {
                        if (parent.tagName.toLowerCase() === 'label') {
                            ...
                            elementData.labelElement = {
                                ...
                                id: parent.id || null,
                                elementPath: getElementPath(parent, true)
                            };
                            break;
                        }
                        parent = parent.parentElement;
                        ...
                        for (const id of labelledbyIds) {
                            ...
                            if (labelElement) {
                                ...
                                labelElements.push({
                                    ...
                                    id: labelElement.id,
                                    elementPath: getElementPath(labelElement, true)
                                });
                            }
                        }
                        ...
                        for (const id of describedbyIds) {
                            ...
                            if (descElement) {
                                ...
                                descriptionElements.push({
                                    ...
                                    id: descElement.id,
                                    elementPath: getElementPath(descElement, true)
                                });
                            }
                        }
